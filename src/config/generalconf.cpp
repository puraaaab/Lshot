...
void GeneralConf::initAllowMultipleGuiInstances()
{
    ...
    tr("Allow multiple CapShot GUI instances simultaneously"), this);
    m_allowMultipleGuiInstances->setToolTip(tr(
            "This allows you to take screenshots of CapShot itself for example"));
...
void GeneralConf::initAutostart()
{
    ...
    m_autostart->setToolTip(tr(
            "Launch CapShot daemon (background process) when computer is booted"));
